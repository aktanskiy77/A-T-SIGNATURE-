...
function App() {
  const products = [
    { id: 1, name: "SPREAD COLOR SHIRT", price: "2.500", img: "src/assets/261MD8216686-C570-F 1.png" },
    { id: 2, name: "SILK AND LINEN SWEATER", price: "2.500", img: "src/assets/261MSY00100-C2386-F 1.png" },
    { id: 3, name: "BLAZER WITH METAL BUTTONS", price: "2.500", img: "src/assets/261MOUTFITMG4579CPNGC9036-E 1.png" },
  ]
    ...
    <div className="min-h-screen bg-[#FEF7E6] overflow-x-hidden">
      ...
      <main className='font-main'>
        ...
        <div className="hidden md:block">
          <img src="src/assets/banner.png" alt="Banner" className='pt-[24px] pl-[15%] w-[1060px]' />
        </div>
